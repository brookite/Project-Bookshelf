...
class Ui_Bookshelf(object):
    def setupUi(self, Bookshelf):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 384, 394))
        ...
        self.menuHelf = QMenu(self.menubar)
        self.menuHelf.setObjectName(u"menuHelf")
        self.menuHelp = QMenu(self.menubar)
        self.menuHelp.setObjectName(u"menuHelp")
        Bookshelf.setMenuBar(self.menubar)

        self.menubar.addAction(self.menuFile.menuAction())
        self.menubar.addAction(self.menuHelf.menuAction())
        self.menubar.addAction(self.menuHelp.menuAction())
        self.menuFile.addAction(self.actionOpen)
        self.menuFile.addAction(self.actionImport)
        self.menuFile.addAction(self.actionExport)
        self.menuFile.addAction(self.actionExit)
        self.menuHelf.addAction(self.actionAdd_new_shelf)
        self.menuHelf.addAction(self.actionSettings)
    ...
    def retranslateUi(self, Bookshelf):
        ...
        self.menuHelf.setTitle(QCoreApplication.translate("Bookshelf", u"Tools", None))
