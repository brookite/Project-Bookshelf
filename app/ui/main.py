...
class Ui_Bookshelf(object):
    def setupUi(self, Bookshelf):
        ...
        self.actionOpenRandom = QAction(Bookshelf)
        self.actionOpenRandom.setObjectName(u"actionOpenRandom")
        ...
        self.menuTools.addAction(self.actionOpenRandom)
    ...
    def retranslateUi(self, Bookshelf):
        ...
        self.actionOpenRandom.setText(QCoreApplication.translate("Bookshelf", u"Open random book", None))
